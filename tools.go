...
// UploadOneFile uploads a single file
...
// JSONResponse is a type used to return JSON
...
// WriteJSON take a reponse status code and arbitrary data and writes json to the client
...
// ErrorJSON takes an error and an optional status code, and sends a JSON response
...
// PushJSONToRemote  posts arbitrary data to a remote uri, and returns a response, status code, and error, if any.
// The fenal parameter, client, is optional. If none is specified, a standard http.Client is used.
